...
class SetupPersonalInfoScreen extends StatefulWidget {
  ...
  @override
  State<SetupPersonalInfoScreen> createState() => _SetupPersonalInfoScreenState();
}
          ...
          children: [
            ...
            Center(
              child: Stack(
                ...
                children: [
                  Obx(
                        ()=>  _userSetupProfileController.userProfileImage.value != null? Container(
                      height: 100,
                      width: 100,
                      ...
                      Image.file(_userSetupProfileController.userProfileImage.value!,
                        fit: BoxFit.cover,)
                    )):Container(
                          height: 100,
                          width: 100,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Stack(
                              ...
                              children: [
                                Obx(() {
                                  final image = _userSetupProfileController.frontImage.value;
                                  return Container(
                                    height: 48,
                                    width: 48,
                                    decoration: BoxDecoration(
                                ...
                                Obx(() {
                                  return _userSetupProfileController.frontImage.value == null
                                      ? Positioned(
                                    child: InkWell(
                                      onTap: () {
                                        _userSetupProfileController.pickFrontImage();
                                      },
                                      child: Padding(
                                        padding: const EdgeInsets.all(5.0),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Stack(
                              ...
                              children: [
                                Obx(() {
                                  final image = _userSetupProfileController.backImage.value;
                                  return Container(
                                    height: 48,
                                    width: 48,
                                    decoration: BoxDecoration(
                                ...
                                Obx(() {
                                  return _userSetupProfileController.backImage.value == null
                                      ? Positioned(
                                    child: InkWell(
                                      onTap: () {
                                        _userSetupProfileController.pickBackImage();
                                      },
                                      child: Padding(
                                        padding: const EdgeInsets.all(5.0),
                                        child: SvgPicture.asset(
