                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        if (widget.isParcel) {
                          //  Parcel accept
                          SocketService().emit('parcel:driver_cancel', data: {
                          ...
                          //  Trip accept
                          SocketService().emit('trip:cancel', data: {
                  ...
                  Expanded(
                    child: CustomButton(
                      onTap: () {
                        if (widget.isParcel) {
                          //  Parcel accept
                          SocketService().emit('parcel:accept', data: {
                            "parcel_id": widget.parcel!.id,
                          });
                          ...
                          //  Trip accept
                          SocketService().emit('trip:accept', data: {
                            "trip_id": widget.trip!.id,
                          });
