...
class ParcelRatePessengersScreen extends StatefulWidget {
  const ParcelRatePessengersScreen({super.key});

  @override
  State<ParcelRatePessengersScreen> createState() =>
      _ParcelRatePessengersScreenState();
}

class _ParcelRatePessengersScreenState
    extends State<ParcelRatePessengersScreen> {
                ...
                Expanded(
                  child: Obx(
                    () => CustomButton(
                      ...
                      onTap: () {
                        _driverController.submitParcelRating(
                          userId:
